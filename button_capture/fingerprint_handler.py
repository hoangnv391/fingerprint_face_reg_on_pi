...
def get_fingerprint():
    ...
    while (finger.get_image() != adafruit_fingerprint.OK) and (time.time() - start_time < 5):
        pass
    print("Templating...")
...
def find_fingerprint(info):
    if get_fingerprint():
        print("Detected #", finger.finger_id, "with confidence", finger.confidence)
        info['id'] = finger.finger_id
        info['confidence'] = finger.confidence
    else:
